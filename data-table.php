            ...
            <div class="sparkline13-list">
              <div class="sparkline13-hd">
                <div class="main-sparkline13-hd">
                  <h1>Products <span class="table-project-n">Data</span> Table<button id="exportButton" class="btn btn-small btn-danger clearfix"><span class="fa fa-file-pdf-o"></span> Export to PDF</button></h1>
                </div>
              </div>
              <div class="sparkline13-graph">
                <div class="datatable-dashv1-list custom-datatable-overright">
                  ...
                  <table id="table" class="table table-hover" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true"
                    data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                    <thead>
                      <tr>
                        <th data-field="state" data-checkbox="true"></th>
                        <th data-field="id">No</th>
                        <th data-field="date" data-editable="true">Tanggal</th>
                        <th data-field="name" data-editable="true">Keterangan</th>
                        <th data-field="company" data-editable="true">Pemasukan</th>
                        <th data-field="price" data-editable="true">Pengeluaran</th>
                      </tr>
                    </thead>
                    <tbody>
                      <?php
        ...
        $("#exportButton").click(function () {
            ...
            dataSource.read().then(function (data) {
                ...
                pdf.table(
                    ...
                    [
                        { field: " ", title: "", width: 0 },
                        { field: "No", title: "No", width: 20 },
                        { field: "Tanggal", title: "Tanggal", width:80 },
                        { field: "Keterangan", title: "Keterangan", width: 200 },
                        { field: "Pengeluaran", title: "Pengeluaran", width: 100 },
                        { field: "Pemasukan", title: "Pemasukan", width: 100 },
                    ],
                    {
                        margins: {
                            top: 50,
